  ...
  return (
    <div className="text-center mb-16">
      <div className="mb-12">
        ...
        <div className="mb-8">
          <img 
            src="/assets/generated_images/Photo_to_3D_hero_banner_b2aa2e35.png?v=2"
      ...
      <div className="text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="text-center">
            <img 
              src="/assets/generated_images/3D_printed_hunting_trophy_f8d62b75.png?v=2"
          ...
          <div className="text-center">
            <img 
              src="/assets/generated_images/3D_printed_pet_memorial_c1dadd77.png?v=2"
          ...
          <div className="text-center">
            <img 
              src="/assets/generated_images/3D_printed_family_keepsake_b65fdf6c.png?v=2"
